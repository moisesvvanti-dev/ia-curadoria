...
function renderBatch() {
    ...
    if (displayedCount >= allItems.length) return;

    const nextBatch = allItems.slice(displayedCount, displayedCount + BATCH_SIZE);
...
window.submitBugReport = async function (e) {
    ...
    const report = {
        ...
        page: document.getElementById('bugPage').value || 'Não especificado',
        email: document.getElementById('bugEmail').value || 'Não informado',
        userAgent: navigator.userAgent,
